							...
							<div class="row justify-content-between">
								<div class="col-lg-12 col-md-12 col-sm-12 pb-4">
									<div class="dashboard_wrap d-flex align-items-center justify-content-between">
										...
										<div class="elkios">
											<a href="add-instructor.html" class="add_new_btn"><i class="fas fa-plus-circle mr-1"></i>Add Instructor</a>
										</div>
									</div>
								</div>
							</div>
													...
													<table class="table dash_list">
														...
														<tbody>
															<tr>
																...
																<td><span class="smalls lg">15 Courses</span></td>
																<td>
															...
															<tr>
																...
																<td><span class="smalls lg">42 Courses</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
															...
															<tr>
																...
																<td><span class="smalls lg">63 Courses</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
															...
															<tr>
																...
																<td><span class="smalls lg">20 Courses</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
															...
															<tr>
																...
																<td><span class="smalls lg">56 Courses</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
