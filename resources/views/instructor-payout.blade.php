										...
										<div class="arion">
											<nav class="transparent">
												<ol class="breadcrumb">
													...
													<li class="breadcrumb-item active" aria-current="page">Instructor Payouts</li>
												</ol>
											</nav>
										</div>
									</div>
									...
									<div class="dashboard_wrap">
										...
										<div class="row">
											<div class="col-xl-12 col-lg-12 col-md-12 mb-4">
												<h6 class="m-0">All Payouts List</h6>
											</div>
										</div>
													...
													<table class="table dash_list">
														...
														<tbody>
															<tr>
																...
																<td><span class="dhs_tags">$120</span></td>
																<td><span class="smalls lg">10 july 2021</span></td>
																<td><span class="trip theme-cl theme-bg-light">Complete</span></td>
																<td>
															...
															<tr>
																...
																<td><span class="dhs_tags">$140</span></td>
																<td><span class="smalls lg">10 Jan 2021</span></td>
																<td><span class="trip theme-cl theme-bg-light">Complete</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
															...
															<tr>
																...
																<td><span class="dhs_tags">$220</span></td>
																<td><span class="smalls lg">10 Nov 2021</span></td>
																<td><span class="trip text-danger bg-light-danger">Pending</span></td>
																<td>
																	<div class="payouts_inf">
																		<a href="#" class="btn_payouts">Pay with Paypal</a>
																		<a href="#" class="btn_payouts">Pay with Stripe</a>
																	</div>
																</td>
															</tr>
															<tr>
																...
																<td><span class="dhs_tags">$149</span></td>
																<td><span class="smalls lg">10 Dec 2021</span></td>
																<td><span class="trip theme-cl theme-bg-light">Complete</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
															...
															<tr>
																...
																<td><span class="dhs_tags">$310</span></td>
