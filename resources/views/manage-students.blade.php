							...
							<div class="row justify-content-between">
								<div class="col-lg-12 col-md-12 col-sm-12 pb-4">
									<div class="dashboard_wrap d-flex align-items-center justify-content-between">
										...
										<div class="elkios">
											<a href="add-students.html" class="add_new_btn"><i class="fas fa-plus-circle mr-1"></i>Add Students</a>
										</div>
									</div>
								</div>
							</div>
													...
													<table class="table dash_list">
														...
														<tbody>
															<tr>
																...
																<td><span class="smalls lg">Web Designing</span></td>
																<td>
															...
															<tr>
																...
																<td><span class="smalls lg">3D Animation</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
															...
															<tr>
																...
																<td><span class="smalls lg">Hraphic Design</span></td>
																<td>
																	<div class="dropdown show">
																		<a class="btn btn-action" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
																			<i class="fas fa-ellipsis-h"></i>
