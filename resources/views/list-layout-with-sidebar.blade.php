												...
												<div class="dlks_152">
													...
													<div class="lmk_485">
														<ul class="shorting_grid">
															...
															<li class="list-inline-item"><a href="list-layout-with-full.html" class="active"><span class="ti-view-list"></span></a></li>
														</ul>
													</div>
												</div>
											</div>
									...
									<div class="crs_lt_2">
										...
										<div class="crs_lt_boxes">
											...
											<div class="crs_grid_list_caption">
												...
												<div class="crs_lt_102">
													<h4 class="crs_tit">How To Learn UI/UX Design pattern for succesfull software Applications</h4>
										...
										<div class="lt_cr_footer">
											<div class="lt_cr_footer_first">
												<ul class="lt_cr_list">
													<li><a href="#" class="prv_li"><i class="fa fa-play text-success"></i>View Preview</a></li>
												</ul>	
											</div>
											<div class="lt_cr_footer_last">
												<ul class="lt_cr_list">
													<li><i class="fa fa-lightbulb text-info"></i>Beginning</li>
