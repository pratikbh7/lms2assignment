					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<div class="breadcrumbs-wrap">
								<h1 class="breadcrumb-title">List Shop with Sidebar</h1>
												...
												<div class="dlks_152">
													...
													<div class="lmk_485">
														<ul class="shorting_grid">
															<li class="list-inline-item"><a href="shop-with-sidebar.html"><span class="ti-layout-grid2"></span></a></li>
															<li class="list-inline-item"><a href="list-shop-with-sidebar.html" class="active"><span class="ti-view-list"></span></a></li>
														</ul>
													</div>
												</div>
											</div>
									...
									<div class="prd_grid_box list_view">
										...
										<div class="prd_grid_caption">
											<div class="prd_center_capt">
												<div class="tag_shby"><span>By Danpreet</span></div>
												<div class="prd_title"><h4>Web Designing Beginning Cource</h4></div>
