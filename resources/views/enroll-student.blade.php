											...
											<div class="col-xl-8 col-lg-10 col-md-12">
												...
												<div class="form-group smalls">
													...
													<div class="simple-input">
														<select id="user" class="form-control">
															<option value="">&nbsp;</option>
															<option value="1">Abhay Pratap</option>
															<option value="2">Adam Kolio</option>
															<option value="3">Reetha Vegum</option>
															<option value="4">Sjaurya Preet</option>
															<option value="5">Akhilesh Pratap</option>
														</select>
													</div>
												</div>
												...
												<div class="form-group smalls">
													...
													<select id="crss" class="form-control">
														...
														<option value="4">3D Animation</option>
														<option value="5">Laravel</option>
													</select>
												</div>
												
												<div class="form-group smalls">
													<button type="button" class="btn theme-bg text-white">Enroll Student</button>
												</div>
